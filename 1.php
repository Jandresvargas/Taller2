...
<head>
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.js"></script>  
        <!-- Funcion para eliminar un dato de la bdg  -->
    <script>
        $(document).ready(function() {
            ...
            // Manejador para el botón de eliminación
...
<body>
     ...
     <header>
        <nav class="navbar bg-body-tertiary fixed-top">
            <div class="container-fluid">
                ...
                <!-- Offcanvas lateral presentación-->
     ...
     <!------------------------------------------ Contenedor donde va el visor ----------------------------------------------------->
    <!-- Container -->
    <div class="container">
            <!-- Barra lateral izquierda -->
        <div id="sidebar" class="leaflet-sidebar collapsed">
            <!-- Cada una de las opciones de la barra  -->
            <div class="leaflet-sidebar-tabs">
                <!-- Opciones de menu de la barra (primeros dos de arriba) -->
                <ul role="tablist">
                    <li><a href="#home" role="tab"><i class="fa fa-home fa-fw"></i></a></li>
                    <li><a href="#autopan" role="tab"><i class="fa fa-table"></i></a></li>
                </ul>

                <!-- opcion de abajo (Botón de GitHub) -->
                <ul role="tablist">
